...
const baseRoutes = [
  ...
  {path: '/profile', name: 'profile', meta: {parent: 'Profile', submenu: 'false', breadcrumb: 'View', breadcrumb2: 'null'}, component: require('@/components/profile/profileShow').default},
  {path: '/profile/edit', name: 'profileEdit', meta: {parent: 'Profile', submenu: 'false', breadcrumb: 'Edit', breadcrumb2: 'null'}, component: require('@/components/profile/profileEdit').default},
  {path: '/profile/password', name: 'profilePassword', meta: {parent: 'Profile', submenu: 'false', breadcrumb: 'Password change', breadcrumb2: 'null'}, component: require('@/components/profile/password').default},
  {
    path: '/403',
