        ...
        <div class="card">
          <div class="card-header card-info">
            ...
            <div class="card-btn pull-right">
              ...
              <router-link tag="a" to="/award" class="btn btn-success btn-sm"><i class="fa fa-list"></i> View All</router-link>
            </div>
          </div>
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-10" id="printThis">
                <div class="table-responsives">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 no-padding">
                      <div class="col-md-12">
                        <h4 class="text-center"><u>Certification</u> </h4>
                      </div>
                      <div class="col-md-12 text-center">
                        <img v-if="form.photo!==''" :src="$baseUrl+form.photo" class="img-responsive">
                      </div>
