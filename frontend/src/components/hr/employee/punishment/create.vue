      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group row  ">
              <label for="title" class="col-md-3 control-label">Punishment Title</label>
              <div class="col-md-8">
               <input id="title" type="text" class="form-control" placeholder="Punishment Title" required v-model="form.title" >
              </div>
            </div>
            <div class="form-group row  ">
...
export default {
  ...
  methods: {
    ...
    async store () {
      await PunishmentService.store(this.form)
        .then(success => {
          console.clear()
            this.$swal({
              type: 'success',
            ...
            this.$router.push({path: '/punishment'})
        })
        .catch(err => {
          this.$swal({
            type: 'warning',
