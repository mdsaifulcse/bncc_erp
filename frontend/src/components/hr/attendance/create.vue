          ...
          <div class="card-body">
              <form @submit.prevent="validateBeforeSubmit">
                <div class="form-group row ">
                  <div class="col-md-4" v-if="auth.role=='superadmin' | auth.role=='hradmin'">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                      <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control"  placeholder="Select Date" required v-model="form.attendance_date"></vuejs-datepicker>
                    </div>
                  </div>
                  <div class="col-md-2">
  ...
  data () {
    return {
      form: {
        ...
        out_time: [],
        attendance: [],
        attendance_date:new Date().toJSON().slice(0,10)
      },
      regiments: '',
      employees: '',
      auth: ''
