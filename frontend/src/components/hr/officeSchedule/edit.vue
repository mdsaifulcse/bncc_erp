              ...
              <form @submit.prevent="validateBeforeSubmit">
                ...
                <div class="row justify-content-center">
                  <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                      <vuejs-datepicker name="in_time" type="time" zone="Asia/Dhaka" use12-hour input-class="form-control " v-model="form.in_time"></vuejs-datepicker>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                      <vuejs-datepicker name="out_time" type="time" zone="Asia/Dhaka" use12-hour input-class="form-control" v-model="form.out_time"></vuejs-datepicker>
