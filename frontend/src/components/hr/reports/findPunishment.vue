      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-info">
            ...
            <h4 class="card-title"> Find Punishment </h4>
          </div>
            ...
            <div v-if="regiment_id!==''">
              ...
              >
                <template slot="items" slot-scope="props">
                  ...
                  <td>
                    <router-link title="Click for view" tag="a" v-bind:to="{ name: 'showPunishment', params: { id: props.item._id } }" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></router-link>
                  </td>
                </template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async findData(){
        if(this.regiment_id!==''){
          const mainData = await ReportService.punishment({regiment_id:this.regiment_id,session_id:this.session_id})
