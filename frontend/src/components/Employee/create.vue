              ...
              <div class="personal-datas">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <label class="control-label"><b>Divisions:</b></label>
                  </div>
                  <div class="col-md-12">
                  ...
                  <div class="row"> <!-- start row-->
                    ...
                    <div class="col-md-12">
                      <div class="form-group form-group-sm">
                        <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" v-validate="'required'" name="do_promotion"  v-model="employee.do_promotion" placeholder="Date of Promotion"></vuejs-datepicker>
                ...
                <div class="row"> <!-- start row-->
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="row"> <!-- start row-->
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="dob" v-model="employee.dob" v-validate="'required'" placeholder="Date of Birth"></vuejs-datepicker>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" v-validate="'required'" name="doj_in_bncc"  v-model="employee.doj_in_bncc"  placeholder="Date of Joining in BNCC" ></vuejs-datepicker>
                  ...
                  <div class="row"> <!-- start row-->
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" v-validate="'required'" name="doj_in_po"  v-model="employee.doj_in_po"  placeholder="Date of Joining in Present Office"></vuejs-datepicker>
                ...
                <div class="row"> <!-- start row-->
                  ...
                  <div class="col-md-12">
                   ...
                   <div class="row"><!-- start sub row-->
                     ...
                     <div class="col-md-12">
                       <div class="form-group">
                         <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="date_of_issue"  v-model="employee.passport_details[0].date_of_issue" placeholder="Date of Issue"></vuejs-datepicker>
                   ...
                   <div class="row"><!-- start sub row-->
                     ...
                     <div class="col-md-12">
                       <div class="form-group">
                         <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="date_of_expire"  v-model="employee.passport_details[0].date_of_expire" placeholder="Date of Expire"></vuejs-datepicker>
                      ...
                      <table class="table table-bordered table-striped table-hover">
                          ...
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="visited_date_from"  v-model="employee.visited_countries[0].visited_date_from" placeholder="From date" ></vuejs-datepicker>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="visited_date_to"  v-model="employee.visited_countries[0].visited_date_to" placeholder="To date"></vuejs-datepicker>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr class="country-visit">
                          ...
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="visited_date_from"  v-model="employee.visited_countries[1].visited_date_from" placeholder="From date"></vuejs-datepicker>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="visited_date_to"  v-model="employee.visited_countries[1].visited_date_to" placeholder="To date"></vuejs-datepicker>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr class="country-visit">
                          ...
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="visited_date_from"  v-model="employee.visited_countries[2].visited_date_from" placeholder="From date"></vuejs-datepicker>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="visited_date_to"  v-model="employee.visited_countries[2].visited_date_to" placeholder="To date"></vuejs-datepicker>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr class="country-visit">
                          ...
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="visited_date_from"  v-model="employee.visited_countries[3].visited_date_from" placeholder="From date"></vuejs-datepicker>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="visited_date_to"  v-model="employee.visited_countries[3].visited_date_to" placeholder="To date"></vuejs-datepicker>
                              </div>
                            </div>
                          </td>
                    ...
                    <div class="country table-responsives">
                      <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr class="country-visit">
                          ...
                          <td>
                            <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="children1_dob" v-model="employee.childrenes[0].children1_dob" placeholder="First Children Date of Birth"></vuejs-datepicker>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>2</td>
                          ...
                          <td>
                            <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="children2_dob" v-model="employee.childrenes[1].children2_dob" placeholder="Second Children Date of Birth"></vuejs-datepicker>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>3</td>
                          ...
                          <td>
                            <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="children3_dob" v-model="employee.childrenes[2].children3_dob" placeholder="Third Children Date of Birth"></vuejs-datepicker>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>4</td>
                          ...
                          <td>
                            <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control"  @change="onchangeSave()" name="children4_dob"  v-model="employee.childrenes[3].children4_dob" placeholder="Forth Children Date of Birth"></vuejs-datepicker>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>5</td>
                          ...
                          <td>
                            <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="children5_dob"  v-model="employee.childrenes[4].children5_dob" placeholder="Fifth Children Date of Birth"></vuejs-datepicker>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>6</td>
                          ...
                          <td>
                            <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="children6_dob"  v-model="employee.childrenes[5].children6_dob" placeholder="Sic Children Date of Birth"></vuejs-datepicker>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>7</td>
                          ...
                          <td>
                            <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="children7_dob"  v-model="employee.childrenes[6].children7_dob" placeholder="Seven Children Date of Birth"></vuejs-datepicker>
                          </td>
                        </tr>
                        </tbody>
                      </table>
                    ...
                    <div class="country table-responsives">
                      <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr class="country-visit">
                          <td>2</td>
                          <td>
                            <input type="text" class="form-control" @change="onchangeSave()"  name="nominee2_name" v-model="employee.nominees[1].nominee2_name"   placeholder="Nominee Name" />
                            <span v-show="errors.has('nominee2_name')" class="help text-danger">{{ errors.first('nominee2_name') }}</span>
                          </td>
                          <td>
                            <input type="text" class="form-control" @change="onchangeSave()"  name="nominee2_religion" v-model="employee.nominees[1].nominee2_religion"   placeholder="Religion" />
                            <span v-show="errors.has('nominee2_religion')" class="help text-danger">{{ errors.first('nominee2_religion') }}</span>
                          </td>
                          <td>
                            <input type="text" class="form-control"  @change="onchangeSave()" name="nominee2_nid" v-model="employee.nominees[1].nominee2_nid"  placeholder="National Id"/>
                            <span v-show="errors.has('nominee2_nid')" class="help text-danger">{{ errors.first('nominee2_nid') }}</span>
                          </td>
                          <td>
                            <input type="text" class="form-control" @change="onchangeSave()"  name="nominee2_percentage" v-model="employee.nominees[1].nominee2_percentage"  placeholder="Nominee Percentage" />
                        ...
                        <tr class="country-visit">
                          <td>3</td>
                          <td>
                            <input type="text" class="form-control" @change="onchangeSave()"  name="nominee3_name" v-model="employee.nominees[2].nominee3_name"   placeholder="Nominee Name" />
                            <span v-show="errors.has('nominee3_name')" class="help text-danger">{{ errors.first('nominee3_name') }}</span>
                          </td>
                          <td>
                            <input type="text" class="form-control"  @change="onchangeSave()" name="nominee3_religion" v-model="employee.nominees[2].nominee3_religion"   placeholder="Religion" />
                            <span v-show="errors.has('nominee3_religion')" class="help text-danger">{{ errors.first('nominee3_religion') }}</span>
                          </td>
                          <td>
                            <input type="text" class="form-control"  @change="onchangeSave()" name="nominee3_nid" v-model="employee.nominees[2].nominee3_nid"   placeholder="National Id"/>
                            <span v-show="errors.has('nominee3_nid')" class="help text-danger">{{ errors.first('nominee3_nid') }}</span>
                          </td>
                          <td>
                            <input type="text" class="form-control"  @change="onchangeSave()" name="nominee3_percentage" v-model="employee.nominees[2].nominee3_percentage"   placeholder="Nominee Percentage" />
                        ...
                        <tr class="country-visit">
                          <td>4</td>
                          <td>
                            <input type="text" class="form-control"  @change="onchangeSave()" name="nominee4_name" v-model="employee.nominees[3].nominee4_name"   placeholder="Nominee Name" />
                            <span v-show="errors.has('nominee4_name')" class="help text-danger">{{ errors.first('nominee4_name') }}</span>
                          </td>
                          <td>
                            <input type="text" class="form-control" @change="onchangeSave()"  name="nominee4_religion" v-model="employee.nominees[3].nominee4_religion"   placeholder="Religion" />
                            <span v-show="errors.has('nominee4_religion')" class="help text-danger">{{ errors.first('nominee4_religion') }}</span>
                          </td>
                          <td>
                            <input type="text" class="form-control"  @change="onchangeSave()" name="nominee4_nid" v-model="employee.nominees[3].nominee4_nid"  placeholder="National Id"/>
                            <span v-show="errors.has('nominee4_nid')" class="help text-danger">{{ errors.first('nominee4_nid') }}</span>
                          </td>
                          <td>
                            <input type="text" class="form-control" @change="onchangeSave()"  name="nominee4_percentage" v-model="employee.nominees[3].nominee4_percentage"  placeholder="Nominee Percentage" />
                      ...
                      <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr class="country-visit">
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control"  @change="onchangeSave()" name="service1_date_from"  v-model="employee.service_record[0].service1_date_from" placeholder="Date"></vuejs-datepicker>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="service1_date_to"  v-model="employee.service_record[0].service1_date_to" placeholder="Date"></vuejs-datepicker>
                              </div>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr class="country-visit">
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()" name="service2_date_from"  v-model="employee.service_record[1].service2_date_from" placeholder="Date"></vuejs-datepicker>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="service2_date_to"  v-model="employee.service_record[1].service2_date_to" placeholder="Date"></vuejs-datepicker>
                              </div>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr class="country-visit">
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="service3_date_from"  v-model="employee.service_record[2].service3_date_from" placeholder="Date"></vuejs-datepicker>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="service3_date_to"  v-model="employee.service_record[2].service3_date_to" placeholder="Date"></vuejs-datepicker>
                              </div>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr class="country-visit">
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="service4_date_from"  v-model="employee.service_record[3].service4_date_from" placeholder="Date"></vuejs-datepicker>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="service4_date_to"  v-model="employee.service_record[3].service4_date_to" placeholder="Date"></vuejs-datepicker>
                              </div>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr class="country-visit">
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="service5_date_from"  v-model="employee.service_record[4].service5_date_from" placeholder="Date"></vuejs-datepicker>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="service5_date_to"  v-model="employee.service_record[4].service5_date_to" placeholder="Date"></vuejs-datepicker>
                              </div>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr class="country-visit">
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control"  @change="onchangeSave()" name="service6_date_from"  v-model="employee.service_record[5].service6_date_from" placeholder="Date"></vuejs-datepicker>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control" @change="onchangeSave()"  name="service6_date_to"  v-model="employee.service_record[5].service6_date_to" placeholder="Date"></vuejs-datepicker>
                              </div>
                            </div>
                          </td>
                          <td>
                ...
                <div class="row"> <!-- start row-->
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      <input type="text" class="form-control" v-model="employee.special_skill" @change="onchangeSave()"  name="specila_skill" placeholder="Enter Special Skill (optional)" />
