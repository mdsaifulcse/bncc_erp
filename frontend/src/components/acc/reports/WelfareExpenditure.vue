            ...
            <div id="printThis">
              <div  v-if="info != '' ">
                <div class="text-center">
                  ...
                  <h4> Welfare Expenditure {{info.session}} </h4>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async showData() {
        const showResult = await BudgetReportsService.welfareExpenditure(this.regiment_id)
        ...
        for(i=0;i<headCount;i++){
          newdata.push({
            ...
            employee_name: this.allData[i].employee.name_english,
        ...
        this.excelFileName = a+'_'+b+'welfareExpenditure.xls'
      },
      monthGet(i){
