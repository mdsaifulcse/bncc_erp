      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header card-info">
            Head Wise Total Budget Received
          ...
          <div class="card-body"  id="printThis">
            ...
            <div class="text-center">
              ...
              <span> <b> Budget {{allData.session.name}} </b></span><br>
...
<script>
  ...
  export default {
    ...
    methods: {
      async getData(){
        const response = await BudgetReportsService.totalReceived()
...
<style>
  ...
  @page { size: landscape; }
  @media print {
    .table tr{page-break-inside:avoid;page-break-after:always}
