      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-info">
            ...
            <h4 class="card-title">Find Budget Expenditure</h4>
          </div>
            ...
            <div id="printThis">
              <div  v-if="info != '' ">
                <div class="text-center">
                  ...
                  <h4> Budget Distribution {{info.session}} </h4>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async showData() {
        const showResult = await BudgetReportsService.regExpenditure(this.regiment_id)
        this.allData = showResult.data.heads
