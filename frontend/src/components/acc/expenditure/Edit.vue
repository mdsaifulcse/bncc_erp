          ...
          <div class="card-body">
            <form @submit.prevent="updateData">
              <div class="form-group row  ">
                ...
                <div class="col-md-8">
                  <select id="session_id" disabled required class="form-control" v-model="form.session_id">
              ...
              <div class="form-group row  ">
                ...
                <div class="col-md-8">
                  <select id="head_id" required disabled readonly class="form-control" v-model="form.head_id">
                    <option value="" selected> -select- </option>
              ...
              <div class="form-group row  ">
                ...
                <div class="col-md-8">
                  <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control"  placeholder="Select Date" required v-model="form.expenditure_date"></vuejs-datepicker>
                </div>
              </div>
              <div class="form-group row  ">
              ...
              <span v-if="expense.type===0">
                ...
                <div class="form-group row  ">
                  ...
                  <div class="col-md-8">
                    <vuejs-datepicker type="date" format="dd-MM-yyyy" input-class="form-control"  placeholder="Cheque Date" required v-model="form.cheque_date"></vuejs-datepicker>
                  </div>
                </div>
                <div class="form-group row  ">
              ...
              <div class="form-group row  ">
                ...
                <div class="col-md-8">
                  <input type="number" min="0" :max="expense.amount-expense.expense_amount+form.amount" v-model="form.amount" class="form-control" placeholder="Amount" value="" id="email">
                </div>
              </div>
              <div class="form-group row">
...
<script>
  ...
  export default {
    ...
    methods: {
      async getData(){
        const response = await ExpenditureService.edit(this.$route.params.id)
      ...
      async updateData () {
        await ExpenditureService.update(this.form)
          .then(res => {
