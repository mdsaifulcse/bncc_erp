...
//View all Data
    async index(req,res,next){
        ...
        if(req.decoded.role==='superadmin' || req.decoded.role!=='hradmin'){
            match = {}
        }
...
//Store Data into DB
    store(req,res,next){
        ...
        let attendance_date = req.body.attendance_date.split('T');
        attendance_date = attendance_date[0]+'T00:00:00.000Z'
        input.attendance_date = new Date(attendance_date);
